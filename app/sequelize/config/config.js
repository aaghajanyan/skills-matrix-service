...
module.exports = {
    ...
    queryTemplate: {
      ...
      users_view: `SELECT u.id, u.email, u.guid as user_guid,u."branch_id" as branch_id, u."position_id" as position_id, \
                    ('[' || us."skill_id" || ',' || us.experience || ',' || us.profficience || ']') as skill_info, \
                    ('[' || uc."category_id" || ',' || uc.experience || ',' || uc.profficience || ']') as category_info \
